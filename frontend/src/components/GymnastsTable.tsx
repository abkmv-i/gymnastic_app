    ...
    return (
      <div className="section-container">
        ...
        <div className="form-grid">
          ...
          <input type="text" placeholder="Имя" value={newGymnast.name} onChange={(e) => setNewGymnast({...newGymnast, name: e.target.value})} />
          <input type="number" placeholder="Год рождения" value={newGymnast.birth_year} onChange={(e) => setNewGymnast({...newGymnast, birth_year: e.target.value})} />
          <input type="text" placeholder="Тренер" value={newGymnast.coach} onChange={(e) => setNewGymnast({...newGymnast, coach: e.target.value})} />
          <input type="text" placeholder="Город" value={newGymnast.city} onChange={(e) => setNewGymnast({...newGymnast, city: e.target.value})} />
          <select value={newGymnast.age_category_id} onChange={(e) => setNewGymnast({...newGymnast, age_category_id: e.target.value})}>
