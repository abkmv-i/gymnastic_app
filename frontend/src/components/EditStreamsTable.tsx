            ...
            <div key={stream.id} className={`stream-item ${hasMatchingGymnasts ? 'has-match' : ''}`}>
              <div className="stream-header" onClick={() => toggleStream(stream.id)}>
                <div className="stream-info">
                  ...
                  <span className="stream-category">Категория: {getAgeCategoryName(stream.age_category_id)}</span>
                  <span className="stream-time">Начало: {formatDate(stream.scheduled_start.toString())}</span>
                            ...
                            <tr key={gymnast.id}>
                              ...
                              <td>
                                ...
                                <div className="gymnast-details">
                                  {gymnast.birth_year && <span>Г.р.: {gymnast.birth_year}</span>}
